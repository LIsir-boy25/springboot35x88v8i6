 ...
 */
@TableName("yichangshangbao")
public class YichangshangbaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YichangshangbaoEntity() {
		
	}
	
	public YichangshangbaoEntity(T t) {
		try {
	...
	private String shangbaozhuangtai;
	 ...
	 * 设置：上报状态
	 */
	public void setShangbaozhuangtai(String shangbaozhuangtai) {
		this.shangbaozhuangtai = shangbaozhuangtai;
	}
	/**
	 * 获取：上报状态
	 */
	public String getShangbaozhuangtai() {
		return shangbaozhuangtai;
	}
	/**
	 * 设置：货主账号
	 */
