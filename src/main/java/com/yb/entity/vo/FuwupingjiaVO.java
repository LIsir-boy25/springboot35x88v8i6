...
public class FuwupingjiaVO  implements Serializable {
	...
	public void setXingjipingfen(String xingjipingfen) {
		this.xingjipingfen = xingjipingfen;
	}
	
	/**
	 * 获取：星级评分
	 */
	public String getXingjipingfen() {
		return xingjipingfen;
	}
