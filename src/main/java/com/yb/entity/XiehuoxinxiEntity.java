...
public class XiehuoxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XiehuoxinxiEntity() {
		
	}
	
	public XiehuoxinxiEntity(T t) {
		try {
	 ...
	 * 设置：卸货图片
	 */
	public void setXiehuotupian(String xiehuotupian) {
		this.xiehuotupian = xiehuotupian;
	}
	/**
	 * 获取：卸货图片
	 */
	public String getXiehuotupian() {
		return xiehuotupian;
	}
	/**
	 * 设置：卸货时间
	 ...
	 * 设置：收货确认
	 */
	public void setShouhuoqueren(String shouhuoqueren) {
		this.shouhuoqueren = shouhuoqueren;
	}
	/**
	 * 获取：收货确认
	 */
	public String getShouhuoqueren() {
		return shouhuoqueren;
	}
	/**
	 * 设置：货主账号
	 */
